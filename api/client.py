...
async def nearest_shopping(lat: float, lon: float, radius_m: int = 2000) -> Optional[dict]:
...
async def nbn_check(address: str) -> Optional[dict]:
    return await _get("nbn/check", {"address": address})
